        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12">
          ...
          <div className="relative flex flex-col md:flex-row items-stretch">
            {imageCards.map((card, index) => (
              <div
                key={index}
                className={`relative h-[500px] rounded-3xl overflow-hidden group shadow-xl flex-1 transition-transform duration-300 hover:scale-[1.02] hover:z-30 ${index > 0 ? 'md:-ml-6' : ''}`}
        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12">
          ...
          {ctaButton && (
            <div className="mt-12 flex justify-center">
              <a
                href={ctaButton.href || '#'}
                className="px-10 py-4 rounded-3xl text-white font-extrabold text-xl hover:scale-105 active:scale-95 transition-all shadow-xl"

...
import type { OrderFormCartSummaryProps } from "../../types/components";
      ...
      <div className="self-stretch flex flex-col justify-start items-start gap-1 w-full">
        ...
        <div className="self-stretch p-4 bg-white rounded-2xl border border-neutral-200 flex justify-between items-end gap-4">
          <div className="flex flex-col items-start">
            ...
            {selectedSize && (
              <span className="text-sm text-zinc-500 mt-1 font-medium bg-neutral-100 px-2 py-0.5 rounded">
                {selectedSizeLabel}: {selectedSize}
              </span>
            )}
          </div>
          <div className="flex items-end gap-4">
            <span className="text-sm lg:text-base text-zinc-600 font-semibold">
              Qty: {quantity}
            </span>
            <span className="text-zinc-800 text-lg lg:text-xl font-semibold leading-6">
              ৳{subtotal}

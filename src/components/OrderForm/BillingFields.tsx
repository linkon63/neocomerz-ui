...
import type { OrderFormBillingFieldsProps } from "../../types/components";
  ...
  return (
    <div className="flex-1 self-stretch p-4 lg:p-6 bg-neutral-100 flex flex-col justify-start items-start gap-6">
      <div className="flex flex-col gap-1">
        <h3 className="text-black text-2xl lg:text-3xl font-bold leading-tight">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <div
                        ...
                        style={{ borderColor: isSelected ? "#65a30d" : "#e5e5e5" }}
                      >
                        {isSelected && (

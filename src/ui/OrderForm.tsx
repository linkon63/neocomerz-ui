          ...
          <div className="flex-1 self-stretch p-4 lg:p-6 bg-neutral-100 flex flex-col justify-start items-start gap-6">
            ...
            <div className="self-stretch rounded-2xl overflow-hidden"
              ...
              <button
                ...
                className="w-full px-5 py-3 lg:px-7 lg:py-3.5 rounded-t-xl inline-flex justify-center items-center gap-2 transition-all duration-300 hover:opacity-95 hover:shadow-xl active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                style={{
                  backgroundColor: primaryColor,
                  boxShadow: `0 0 0 4px ${primaryColor}30`
                }}
              >
                <LuShoppingBag className="w-8 h-8 lg:w-10 lg:h-10 text-white" />
